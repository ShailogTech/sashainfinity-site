...
export default function TeacherSidebar() {
  ...
  const links = [
    ...
    { label: "Grading", href: "/teacher/grading", icon: <IconChecks className={ICON_CLASS} /> },
    { label: "Profile", href: "/teacher/profile", icon: <IconUser className={ICON_CLASS} /> },
        ...
        <div>
          <SidebarLink
            link={{
              ...
              href: "#",
              icon: (
                <div className="h-7 w-7 shrink-0 rounded-full bg-amber-500 flex items-center justify-center text-white text-xs font-bold">
                  T
                </div>
              )
            }}
